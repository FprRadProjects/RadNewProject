...
class ReportDesigner extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <LoadScript id="stimulsoft" src="stimulsoft/stimulsoft.reports.merged.js"/>
...
const connectedReportDesigner =  ReportDesigner ;
export {connectedReportDesigner as ReportDesigner};
